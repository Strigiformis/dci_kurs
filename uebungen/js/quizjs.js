  ...
  createOptions: function () {
    ...
    t.intoContainer(
      t.createElement({
        tag: "h2",
        text:
          "(" + t.currentQuestion.category + ") " + t.currentQuestion.question,
      })
    );
    t.intoContainer(ul);
    // create options
  ...
  data: [
    {
      category: "HTML",
      question:
        "Welches Markup führt dazu, dass das Element per Tastatur&shy;steuerung anwählbar ist?",
      solution: '&lt;span tabindex="0">Pick me!&lt;/span>',
      falses: [
        '&lt;a class="button">Pick me!&lt;/a>',
        '&lt;span role="button">Pick me!&lt;/span>',
        '&lt;span aria-type="button">Pick me!&lt;/span>',
      ],
      explanation:
        "Durch tabindex können Sie jedes Element fokussierbar machen, ein Wert von 0 behält dabei die generische Reihenfolge bei.",
    },
    {
      category: "HTML",
      ...
      explanation:
        'Cyrl steht für Kyrillisch, das gibts genauso wie es ru-Latn gibt: <p lang="de">Er sagte <q lang="ru-Latn">Spasibo!</q> und ging.</p> Es gibt auch ru-Cyrl: <p lang="ru">Он сказал <q lang="fr-Cyrl">Мерси!</q> и ушёл.</p> <br> en-UK gibt’s nicht; das Länder&shy;kennzeichen für Groß&shy;britannien ist GB. Britisches Englisch also en-GB.',
    },
    {
      category: "HTML",
      question:
        "Welches Markup sollte für ein dekoratives Bild aus Gründen der Barriere&shy;freiheit verwendet werden?",
      ...
      explanation:
        "Durch ein leeres alt-Attribut verzichten Screenreader auf ein Vorlesen des Dateinamens. Alternativ kommt auch die Verwendung eines Hinter&shy;grundbildes infrage.",
    },
    {
      category: "HTML",
    ...
    },
    {
      ...
      explanation:
        "Die starre Festlegung, dass inline-Elemente keine Block-Elemente enthalten dürfen, gibt es nicht mehr.",
    },
    {
      category: "HTML",
      question:
        "Wie oft darf das main-Element in einem HTML-Dokument vorkommen?",
    ...
    },
    {
      category: "HTML",
      question:
        "HTML5 führte zur Auszeichnung der Dokument&shy;struktur neue Elemente ein: article und section. Welche Schachtelung ist erlaubt?",
    ...
    },
    {
      category: "HTML",
      question:
        "Mit welcher Priorität werden die Angaben (sofern vorhanden) laut Standard zur Bestimmung der Zeichen&shy;codierung eines HTML-Dokuments verwendet?",
      solution: "1. BOM 2. HTTP-Header 3. meta-charset",
      falses: [
        "1. HTTP-Header 2. meta-charset",
    ...
    },
    {
      category: "HTML",
      question:
        "Wie erreicht man, dass ein Browser je nach Fenstergröße unterschiedliche Bilddateien lädt?",
      solution: "Mit srcset-Attribut bzw. picture-Element.",
      falses: [
        "Das geht nur bei Hintergrundbildern per Media-Queries in CSS.",
    ...
    },
    {
      ...
      explanation:
        "Mit HTML5 sind auch Zahlen als Anfangsbuchstaben erlaubt. In CSS sind am Anfang eines Bezeichners nicht alle Zeichen zulässig, sodass man dort nicht erlaubte Zeichen escapen muss.",
    },
    {
      category: "CSS",
      question:
        "Welche Browser unterstützen die Eigenschaft text-align-last noch nicht?",
      solution: "Safari",
      falses: [
    ...
    },
    {
      category: "CSS",
      question:
        "Welcher Browser unterstützt noch keine automatische Silbentrennung per CSS?",
      solution: "Chrome und Opera",
      falses: ["Firefox", "Chrome", "Safari"],
      explanation:
        "Chrome hat die Eigenschaft hyphens nur in Version 55 für Mac implementiert.",
    },
    {
      category: "CSS",
      ...
      falses: [
        "fill: #c0ffee",
        "font: bold 1.2em/1.5 serif",
        "text-align: start",
      ],
      explanation:
        "Bei calc müssen die Rechenzeichen + und -, nicht aber * und / , durch Leerzeichen von den Operatoren getrennt werden.",
    },
    {
      category: "CSS",
      question:
        "Gegenwärtige Browser&shy;unterstützung außen vor, was ergibt laut Spezifikation keinen dunkelblauen Hintergrund?",
      solution: "background-color: linear-gradient(#006, #008)",
      falses: [
        "background-color: darkblue",
        "background-color: #006f",
        "background-color: hsl(240deg, 100%, 30%)",
      ],
      explanation:
        'Laut CSS Color Module Level 4 ist die Angabe des Hue-Winkels(!) auch mit deg erlaubt. <br> Die vierstelligen Angaben werden in RGBA umgewandelt, ergeben daseelbe wie #000066ff und rgba(0, 0, 102, 1).<br> Damit ist "background-color: linear-gradient(#006, #008)" falsch, es muss "background" oder besser "background-image" heißen.',
    },
    {
      category: "CSS",
      question: "Die Angabe der Zeichencodierung einer CSS-Datei ist …?",
      solution:
        "… nicht erforderlich, wenn HTML-Datei und CSS-Datei dieselbe Zeichencodierung verwenden",
      falses: [
        "… gemacht mit @charset 'UTF-8'; am Anfang der CSS-Datei",
    ...
    },
    {
      category: "CSS",
      question:
        "Unterstützung durch die verwendete Schriftart vorausgesetzt, lässt sich per CSS vieles erreichen. Aber was nicht?",
      solution:
        "Dass gerade Anführungszeichen (' und \") als smart quotes (“”/‘’) dargestellt werden.",
      falses: [
      ...
      explanation:
        "Nullen kann man mit dem OpenType-Feature gestalteten: http://www.preusstype.com/techdata/otf_zero.php",
    },
    {
      question:
        "Wie nennt man den Ansatz, Grund&shy;funktionalität auch für nicht so gute Geräte bereitzustellen und für fähigere Geräte bessere Funktionen anzubieten?",
    ...
    },
    {
      ...
      solution:
        "Man verdient an: <br> ● man hat was, was andere gerne hätten <br> ● man kann was, was andere nicht können <br> ● mn darf was, was andere nicht dürfen<br> Das hat mir in Momenten der Orientierungslosigkeit eigentlich immer geholfen, am nächsten Tag wieder Geld zu verdienen. <br> (Tom)",
      falses: [
    ...
    },
    {
      ...
      explanation:
        "Cheatah führt mit 275 Zitaten die Liste an, es folgen ChrisB mit 112, Gunnar Bittersmann mit 83, at mit 76 und Der Martin mit 75 Zitaten",
    },
    {
    ...
    },
    {
      ...
      falses: [
        "mit den Elementen circle oder ellipse",
        "mit den Elementen circle, ellipse und path",
        "nur mit dem circle-Element",
      ],
      explanation:
        "einen Kreis erreichen Sie natürlich mit einem circle-Element, aber auch wenn bei einer ellipse rx und ry gleich sind, mit einem Pfad mit einem Kreisbogen und mit einem rect, dessen rx und ry-Radius die Hälfte der Breite und Höhe beträgt.",
    },
    {
      category: "SVG",
      question:
        "In SVG 2 wird XLink zugunsten von normalen href-Attributen deprecated. In welchen Browsern funktioniert dies (Stand Dezember 2016) noch nicht?",
      solution: "Firefox und Safari",
      falses: ["IE 9-11", "alle Microsoft-Browser", "IE 9-11, Edge und Safari"],
      explanation:
        "Wider Erwarten hat selbst IE 9 dies implementiert. Firefox 51 wird im Januar 2017 nachziehen, sodass dann nur Safari und ältere Browser noch zwingend XLink:href benötigen.",
    },
    {
      category: "SVG",
      ...
      falses: [
        "eine width-Angabe vornehmen",
        "den Text mit br formatieren",
        "das line-Attribut verwenden",
      ],
      explanation:
        "In SVG 2 ist es geplant mit einem width-Angabe mehrzeiligen Text zu ermöglichen, bis dahin muss man mehrere tspan-Elemente verwenden.",
    },
    {
      category: "SVG",
      question:
        "Wie können Sie in SVG Präsentations&shy;eigenschaften animieren?",
      ...
      explanation:
        "CSS-Animationen in SVG funktionieren in allen modernen Browsern, aber noch nicht im IE<11.",
    },
    {
      category: "SVG",
      question:
        "Mit dem stroke-Attribut können Sie die Randlinien von Text und anderen grafische Objekten gestalten. Nicht möglich sind jedoch: …",
      solution: "variable Randstärken",
      falses: [
        "Strichelungen in Morse-Code",
        "mehrfarbige Muster",
        "radiale Verläufe",
      ],
      explanation:
        "Umrandungen sind gegenüber CSS3 eine der Stärken von SVG, die in ein CSS Modul fills und strokes übernommen werden sollen. Allerdings sind variable Strichstärken für natürlichere Formen (noch) nicht möglich.",
    },
    {
      category: "SVG",
      question:
        "Wie können Sie in SVG die Größe einer Grafik mit CSS animieren?",
      solution: "durch die Animation der (gleichfarbigen) Randstärke",
      falses: [
        "durch die Verschiebung der x- und y-Koordinaten",
        "durch transform: scale(x,y)",
        "durch die Animation des width- und height-Attributs",
      ],
      explanation:
        "In SVG 2 werden Größenangaben wie x,y, width und height zu animierbaren Präsentations&shy;eigenschaften. Die CSS-Animation von Transformationen wäre ein guter Weg, ist im Edge jedoch noch nicht möglich. So bleibt nur die Animation der Ranstärke. ",
    },
    {
      category: "SVG",
      question: "Das viewBox-Attribut ermöglicht es, …",
      solution:
        '… einen pixelorientierten Ausschnitt mit fester Pixelbreite in einem  "neuen" Koordinaten&shy;system an eine beliebige verfügbare Breite anpassen',
      falses: [
        "… Grundformen passend zu skalieren",
      ...
      explanation:
        'Mit dem viewbox-Attrbut können Sie SVG-Grafiken in einem "neuen" Koordinatensystem passend skalieren. Da es keine Präsentations&shy;eigenschaft ist, kann es aber nicht mit CSS animiert werden.',
    },
  ],
